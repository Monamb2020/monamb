...
async function transformation(element, form, client) {
    ...
    let status = [];
    let c = -1;  
    if (form["INFO_DETALLADA/IN_SITU/Resultados_temperatura/group_ce2bv42_temperatura_RESULTADO"]>0){
        ...
        status [c] = insertInsitu(params7, client);  
    }
    
    if (form["INFO_DETALLADA/IN_SITU/Resultados_OD/group_ce2bv42_od_RESULTADO"]>0){
        ...
        status [c] = insertInsitu(params8, client);
    }
    
    if (form["INFO_DETALLADA/IN_SITU/Resultados_pH/group_ce2bv42_ph_RESULTADO"]>0){
        ...
        status [c] = insertInsitu(params9, client); 
    }

    if (form["INFO_DETALLADA/IN_SITU/Resultados_conductividad/group_ce2bv42_conductividad_RESULTADO"]>0){
        ...
        status [c] = insertInsitu(params10, client); 
    }
    
    if (form["INFO_DETALLADA/IN_SITU/Resultados_SSED/group_ce2bv42_ssed_RESULTADO"]>0){
        ...
        status [c] = insertInsitu(params11, client);
    }
